const InstructorCard = ({ singleUser }) => {
  return (
    <div className="shadow-2xl shadow-[#E0B573] hover:shadow-[#E0B573] card mx-auto w-96 glass overflow-hidden relative transition duration-200 transform hover:-translate-y-4 rounded  hover:shadow-2xl m-auto h-96">
      <figure>
        <img
          src={singleUser?.img}
          alt="Movie"
